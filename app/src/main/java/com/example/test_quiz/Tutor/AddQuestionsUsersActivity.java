...
public class AddQuestionsUsersActivity extends AppCompatActivity {
  /*
    @Override
  protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_add_questions_users);
    }*/
  EditText question;
    EditText aText;
    EditText bText;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        f2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(AddQuestionsUsersActivity.this, String.valueOf(previousQuestion), Toast.LENGTH_SHORT).show();
            }
        });
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (cont)
                {
                    previousQuestion++;
                    currentQuestion++;
                    Toast.makeText(AddQuestionsUsersActivity.this, "QUESTION " + currentQuestion, Toast.LENGTH_SHORT).show();
                    questionNumber.setText(String.valueOf(currentQuestion));
                    clearAllData();
                    f2.setVisibility(View.VISIBLE);
                }
        ...
        fl.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(jsonArray.length()!=0)
                {
                    ...
                    LayoutInflater li = LayoutInflater.from(AddQuestionsUsersActivity.this);
                    View promptsView = li.inflate(R.layout.dialog_custom, null);
                    AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(
                            AddQuestionsUsersActivity.this);
                            ...
                            .setPositiveButton("OK",
                                    new DialogInterface.OnClickListener() {
                                        public void onClick(DialogInterface dialog,int id) {
                                            ...
                                            String temp2 = str;
                                            String tutorId = auth.getUid();
                                            String groupId = "perviy b";
                                            ...
                                            try {
                                                ...
                                                tempObject.put("TutorId", tutorId);
                                                tempObject.put("GroupId", groupId);
...
//                                         result.setText(userInput.getText());
    ...
    public void onBackPressed() {
        final AlertDialog.Builder builder = new AlertDialog.Builder(AddQuestionsUsersActivity.this);
